...
elasticache_clusters = {
  /* redis-test-tf = {
    ...
    redis_sg_name = "terraform-20211004120224498900000001"
    redis_subnet_group_name = "redis-test-tf-subnet" 
    redis_subnet_ids = [
    ...
    redis_cluster_name = "redis-test-tf-"
    redis_replication_group_id = "redis-test-tf"
    redis_replication_group_description = "redis-test-tf"
    ...
    redis_notification_topic_arn = "arn:aws:sns:us-east-1:133638536280:steady-data-dev-topic"
  ...
  redis-data-dev = {
    ...
    redis_cluster_name                  = "redisClusterDataDev"
    redis_replication_group_id          = "redis-data-dev"
    redis_replication_group_description = "Redis Data Dev Cluster"
    redis_number_cache_clusters         = 1
  ...
  redis-dev = {
    ...
    redis_cluster_name                  = "redisClusterDev"
    redis_replication_group_id          = "redis-dev"
    redis_replication_group_description = "Redis Dev Cluster"
